...
class config:
    ...
    pretrain_ckpt_file: str = './checkpoints/7b-finetune/iter-2000-merged.pth'  # load fine-tuned checkpoint
    ...
    train_head: str = 'scalar_head'  # train scalar_head is required since the output layer is initialized randomly
