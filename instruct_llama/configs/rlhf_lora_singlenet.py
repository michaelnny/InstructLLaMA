...
@dataclass
class config:
    """Trains policy network with value head using PPO (RL) and LoRA"""
    ...
    value_coef: float = 0.1  # lesser weight for value loss as we're using shared network
    ...
    # others
    seed: int = 152
    log_dir: str = './logs/rlhf_lora_singlenet'  # save logs and traces
    ckpt_dir: str = './checkpoints/rlhf_lora_singlenet'
